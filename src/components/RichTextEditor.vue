<template>
  <div class="flex flex-col border-solid border-2 border-gray-200 rounded">
    <div
      class="flex space-x-8 border-solid border-b-2 border-gray-200 divide divide-gray-500 p-2 overflow-x-auto"
    >
      <div class="flex space-x-8" v-if="!isEditingLink">
        <div class="flex space-x-2">
          <button
            class="select-none p-4 w-8 h-8 flex justify-center items-center hover:bg-gray-100 rounded"
            @click="toggleBold"
          >
            <div
              v-html="icons.bold"
              key="bold"
              :class="
                isSelectionBold === true ? 'fill-blue-500' : 'fill-gray-500'
              "
            ></div>
          </button>
          <button
          ...
          >
            <div
              v-html="icons.italic"
              :class="
                isSelectionItalic === true ? 'fill-blue-500' : 'fill-gray-500'
              "
            ></div>
          </button>
          <button
            class="select-none w-8 h-8 flex justify-center items-center hover:bg-gray-100 rounded"
            @click="toggleStriked"
          >
            <div
              v-html="icons.striked"
              :class="
                isSelectionStriked === true ? 'fill-blue-500' : 'fill-gray-500'
              "
            ></div>
          </button>
        </div>
        ...
        <div class="flex space-x-2">
          ...
          >
            <div
              ...
              :class="
                isSelectionLeft === true ? 'fill-blue-500' : 'fill-gray-500'
              "
            ></div>
          </button>
          <button
          ...
          >
            <div
              ...
              :class="
                isSelectionCenter === true ? 'fill-blue-500' : 'fill-gray-500'
              "
            ></div>
          </button>
          <button
            class="w-8 h-8 flex justify-center items-center hover:bg-gray-100 rounded"
            @click="toggleJustifyRight"
          >
            <div
              v-html="icons.justifyRight"
              :class="
                isSelectionRight === true ? 'fill-blue-500' : 'fill-gray-500'
              "
            ></div>
          </button>
        </div>
        <div class="flex items-center space-x-2">
          ...
          >
            <div
              v-html="icons.link"
              :class="
                isSelectionLink === true ? 'fill-blue-500' : 'fill-gray-500'
              "
            ></div>
          </button>
          <button
            ref="emoji"
            class="select-none trigger-emote w-8 h-8 flex justify-center items-center hover:bg-gray-100 rounded"
            :class="
      ...
      <div class="flex space-x-4" v-else>
        ...
        <div class="flex space-x-2">
          <button
            class="w-8 h-8 flex justify-center items-center bg-green-100 rounded select-none"
            @click="validateLinkEditing"
          >
            <div v-html="icons.validate" class="fill-green-500"></div>
          </button>
          <button
            class="w-8 h-8 flex justify-center items-center bg-red-100 rounded select-none"
    ...
    <div
      id="editor"
      ref="content"
      class="p-2 output outline-none min-h-24"
      :class="
        editorValue === 'Rédiger votre texte' ? 'text-gray-400' : 'text-black'
      "
      @input="change"
...
export default {
  ...
  methods: {
    ...
    onFocusOut() {
      if (
        this.value === "" ||
        this.value === '<div style="text-align: left;"><br></div>' ||
        this.value === '<div style="text-align: left;"></div>' ||
        this.value === "<br>"
      ) {
        this.editorValue = "Rédiger votre texte";
        this.$emit("change", "");
